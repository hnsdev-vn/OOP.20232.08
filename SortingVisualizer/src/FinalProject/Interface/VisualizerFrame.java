...
public class VisualizerFrame extends JFrame {
	...
	private final String[] Sorts = {"Selection", "Merge", "Shell", "Bubble", "Insertion"};
	...
	public VisualizerFrame() {
		...
		start.setPreferredSize(new Dimension(200, start.getPreferredSize().height));
		...
		option = new JLabel("SORTING OPTIONS");
		...
		stepped = new JCheckBox("Gradual Increase in Values");
	...
	public void preDrawArray(Integer[] squares) {
		...
		for (int i = 0; i < SortingVisualizer.sortDataCount; i++) {
			...
			squarePanels[i].setPreferredSize(new Dimension(SortingVisualizer.blockWidth+5, squares[i] * sizeModifier));
